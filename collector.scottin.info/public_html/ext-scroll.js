/**
 * ext-scroll.js â€” Scroll Depth Extension
 * CSE 135 - Module 09: Extensions & Plugins
 *
 * Tracks how far users scroll down the page:
 *   - Reports at 25%, 50%, 75%, and 100% thresholds
 *   - Reports final max depth on page hide
 *   - Uses requestAnimationFrame throttling for performance
 *
 * Register with: collector.use(ScrollTracker)
 */
...
window.ScrollTracker = {
  ...
  _measure: function() {
    ...
    // Dispatch a custom event so test pages can read scroll data
